...
@WebServlet(name = "insertAutor", urlPatterns = {"/insertAutor"})
public class insertAutor extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        {
            Autors autor = JsonAutorsMapper.fromJson(json);
            AutorsController controller = new AutorsController();
            int count = controller.insertAutors(autor);
